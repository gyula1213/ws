...
public class Kereszt implements Gameable
{
    ...
    {
    	if (!(game instanceof Kereszt))
    		return false;
    	
    	int [] stage = ((Kereszt)game).getStage();
...
//	jobb_also_1, jobb_also_2, jobb_felso_1, jobb_felso_2, bal_felso_1, bal_felso_2, bal_also_1, bal_also_2
	...
	private static int [] pill = {6,4,1,1,1,1,1,1,     2,2,1,2,2,2,2,2,     3,1,3,6,3,3,3,3,     3,4,5,5,4,4,4,4,     3,1,6,4,5,5,5,5,     5,6,4,2,6,6,6,6,      };
